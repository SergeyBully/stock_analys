...
class CTkDatePicker(ctk.CTkFrame):
    def __init__(self, master=None, **kwargs):
        ...
        self.date_entry = ctk.CTkEntry(self, width=100)
    ...
    def set_insert_date(self, index, insert_date):
        self.date_entry.insert(index, insert_date)
    def open_calendar(self):
        ...
        input_year = self.date_entry.get()[:4]
        input_date = self.date_entry.get()[5:7]
        try:
            self.current_year = int(input_year)
            self.current_month = int(input_date)
        except:
    ...
    def build_calendar(self):
        ...
        month_label = ctk.CTkLabel(self.calendar_frame,
            ...
            for day_col in range(7):
                if week == 2 and day_col < start_day:
                    ...
                    btn = ctk.CTkButton(self.calendar_frame, text=str(day), width=3,
                                        command=lambda d=day: self.select_date(d), fg_color="transparent")
